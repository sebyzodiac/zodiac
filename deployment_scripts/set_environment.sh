...
export SIRMIONE_ALIAS=sksirmione
export LIMONE_ALIAS=sklimone
export SCORPIO_ALIAS=skscorpio
export VIRGO_ALIAS=skvirgo
export LIBRA_ALIAS=sklibra
export ZODIAC_ALIAS=skzodiac
export DB_ADMIN_USER=skdba
